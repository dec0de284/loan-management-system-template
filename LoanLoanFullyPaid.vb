...
Public Class LoanLoanFullyPaid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LoanManagementSystem.LoanLoanFullyPaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLoanLoanFullyPaid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LoanLoanFullyPaid = New LoanLoanFullyPaid()
        rpt.Site = Me.Site
        Return rpt
    End Function
