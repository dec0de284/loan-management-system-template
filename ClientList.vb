Public Class ClientList
    ...
    Private Sub btn_Edit_Click(sender As Object, e As EventArgs) Handles btn_Edit.Click
        ...
        If ClientID <> "" Then
            ...
            EditClientForm.Show()
        Else
            InformationMessage("Please select a client to edit.", "")
        End If
    End Sub

    Private Sub btn_AddCapitalShare_Click(sender As Object, e As EventArgs) Handles btn_AddCapitalShare.Click
        If ClientID <> "" Then
            'show edit form
